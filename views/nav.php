        ...
        <div class="nav">
            ...
            <?php if(isset($_SESSION['email'])){echo  '<li class="nav_item" alt="Profile"><a href="../views/profilepage.php">
                ...
                { 
                    ...
                    {
                        echo '<li class="nav_item "><a href="TBOReqIshan.php"><i class="fa fa-clone"></i> Request</a></li>';
                    }
                     if($_SESSION['level']=='student')
                    {
                        echo '<li class="nav_item "><a href="TBOReqIshan.php"><i class="fa fa-clone"></i> Confirm List</a></li>';
                    }

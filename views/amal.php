...
<?php include 'nav.php' ?>
    ...
    <div class="containe">
        ...
        <div class="details">
            <h1>Hi, I am Amal </h1>
            <p>I am an undergraduate of the University of Colombo School of Computing. I am a passionate individual.My interested areas are programming, Web development and  fullstack development. 
